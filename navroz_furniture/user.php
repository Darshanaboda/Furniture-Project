...
<body>
    ...
    <div class="custom-container">
        ...
        <div style="width:60%">
            ...
            <a class="addlink" href="./adduser.php">
             <span > Add User</span>
            </a>
            <table>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <a href="./edituser.php?id=<?php echo $data['id']; ?>" style="margin-right:10px"> Edit </a>
                        <a href="./check-deleteuser.php?id=<?php echo $data['id']; ?>"> Delete </a>
